...
import { Accessibility } from "./accessibility-ow";
import { MenuToggle } from "./menuToggle-ow";
  ...
  return (
    <NavLinksContainer>
      ...
      <LinksWrapper isOpen={isOpen}>
        ...
        <LinkItem><Link href="./employee">พนักงาน</Link></LinkItem>
        <LinkItem><Link href="./table">โต๊ะ</Link></LinkItem>
        <Marginer />
